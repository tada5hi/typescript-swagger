...
describe('index.ts', () => {
    it('isLibraryIncluded', () => {
        ...
        expect(isLibraryIncluded('typescript-rest', {useLibrary: {"typescript-rest":  ["CLASS_PATH" as Decorator.Type]} as Record<Library, any>})).toBeTruthy();
        expect(isLibraryIncluded('typescript-rest', {useLibrary: {"@decorators/express":  ["CLASS_PATH" as Decorator.Type]} as Record<Library, any>})).toBeFalsy();
    ...
    it('findLibraryIDRepresentation', () => {
        ...
        expect(findLibraryIDRepresentation('typescript-rest', 'CLASS_PATH', {useLibrary: {"typescript-rest":  ["CLASS_PATH" as Decorator.Type]} as Record<Library, Decorator.Type[]>})).toBeDefined();
        ...
        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"@decorators/express": 'RESPONSE_DESCRIPTION'} as Record<Library, Decorator.Type>})).toBeUndefined();
        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"typescript-rest": 'RESPONSE_DESCRIPTION'} as Record<Library, Decorator.Type>})).toBeUndefined();
        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"typescript-rest": 'CLASS_PATH'} as Record<Library, Decorator.Type>})).toBeDefined();

        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"typescript-rest": ['CLASS_PATH']} as Record<Library, Decorator.Type[]>})).toBeDefined();
        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"typescript-rest": ['RESPONSE_DESCRIPTION']} as Record<Library, Decorator.Type[]>})).toBeUndefined();

        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"typescript-rest": {"CLASS_PATH": true}} as Record<Library, Record<Decorator.Type, boolean>>})).toBeDefined();
        expect(findLibraryIDRepresentation('typescript-rest','CLASS_PATH', {useLibrary: {"typescript-rest": {"CLASS_PATH": false}} as Record<Library, Record<Decorator.Type, boolean>>})).toBeUndefined();
  });
});
